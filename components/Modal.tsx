    ...
    return (
        <div className={`flex ${isTextarea ? 'items-start' : 'items-center'} group/row`}>
            ...
            <div className="w-full">
                ...
                <p className="break-words w-full text-gray-300 text-sm">
        ...
        <div className="w-full md:w-1/3 p-8 md:p-10 flex flex-col text-gray-300 overflow-y-auto bg-[#0d1016]">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 pt-8 border-t border-white/5">
              <InfoRow icon={<CameraIcon className="w-5 h-5" />} label="使用カメラ" value={photo.camera} />
              {photo.lens && <div className="pl-9 -mt-4">
                <InfoRow icon={<></>} label="使用レンズ" value={photo.lens} />
              </div>}
